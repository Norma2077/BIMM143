...
I can get the mean of the home work scores after dropping the lowest score by doing:
...
We want to know the position of the NAs. So for student2 we can used the following.
...
The toughest homework will be hw 2 considering the mean and considering missing homework as 0.
